...
namespace EbayTestAutomation
{
    class EbayTests
    {
        ...
        {
            steps.Register(settings["EMAIL"], settings["EMAIL"], settings["FIRSTNAME"], settings["LASTNAME"],
                settings["PASS"], settings["PHONE"], settings["COUNTRY"]);
        ...
        {
            steps.Register(settings["EMAIL"], settings["SECOND_EMAIL"], settings["FIRSTNAME"], settings["LASTNAME"],
                settings["PASS"], settings["PHONE"], settings["COUNTRY"]);
        ...
        {
            steps.Register(settings["INCORRECT_EMAIL"], settings["INCORRECT_EMAIL"], settings["FIRSTNAME"], settings["LASTNAME"],
                settings["PASS"], settings["PHONE"], settings["COUNTRY"]);
        ...
        {
            steps.Register(settings["EMAIL"], settings["EMAIL"], settings["FIRSTNAME"], settings["LASTNAME"],
                settings["EMAIL"], settings["PHONE"], settings["COUNTRY"]);
        ...
        {
            steps.Register(settings["EMAIL"], settings["EMAIL"], settings["FIRSTNAME"], settings["LASTNAME"], 
                settings["PASS_CONTAINS_ONLY_DIGITS"], settings["PHONE"], settings["COUNTRY"]);
        ...
        {
            steps.Register(settings["EMAIL"], settings["EMAIL"], settings["FIRSTNAME"], settings["LASTNAME"],
                settings["SHORT_PASS"], settings["PHONE"], settings["COUNTRY"]);
